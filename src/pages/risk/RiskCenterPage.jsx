  ...
  return (
    ...
    >
      <Typography
        variant="caption"
        fontWeight={700}
        color={score >= 15 ? 'error.main' : score >= 8 ? 'warning.main' : 'success.main'}
      >
        {score}
      </Typography>
      ...
      {cellRisks.length > 0 && (
        <Chip
          ...
          size="small"
          color={score >= 15 ? 'error' : score >= 8 ? 'warning' : 'success'}
...
function RiskCenterPage() {
  ...
  return (
    <Box>
      <SectionHeader
        title="Risk Center"
        subtitle="Monitor, assess and mitigate organizational risks"
      />
      ...
      <Grid container spacing={2} mb={3}>
        ...
        <Grid item xs={6} sm={3}>
          <KpiCard
            title="High Severity"
            value={highRisk}
            icon={<PauseCircleIcon sx={{ fontSize: 20 }} />}
            color="warning.main"
          />
        </Grid>
      </Grid>
                    ...
                    <Box key={l} display="flex" alignItems="center" gap={0.5} mb={0.5}>
                      <Box width={72} textAlign="right" pr={1}>
                        <Typography
                          ...
                          sx={{ fontSize: '0.65rem' }}
                        >
                          {MATRIX_LABELS.likelihood[l]}
                        </Typography>
                      </Box>

                      {[1, 2, 3, 4, 5].map((i) => (
                        <RiskMatrixCell key={i} l={l} i={i} risks={risks} />
                      ))}
                    </Box>
                  ))}
